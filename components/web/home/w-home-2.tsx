  ...
  return(
    <div className='w-full h-auto bg-black'>
      <nav className="flex flex-col lg:flex-row px-2 sm:px-20 py-4 bg-dark-700">
        <div className="w-full flex flex-wrap justify-center lg:justify-between items-center">
          ...
          <div className="flex items-center">
            <span className="text-lg text-white"><GoSearch /></span>
      ...
      <div className="h-512 flex flex-col justify-center items-center">
        <h1 className='w-full sm:w-4/5 xl:w-35 text-white text-center text-4xl sm:text-5xl font-bold font-raleway leading-tight mb-10'>Artistas altamente creativos y profesionales</h1>
      ...
      <div className="px-5 sm:px-10 lg:px-20">
        <div className="flex flex-wrap justify-center sm:justify-between mb-6">
          <div className='flex items-center space-x-2 mb-3 sm:mb-0 mr-3'>
            <span className="text-red-600 text-3xl"><TiLocationOutline /></span>
            <Link href=''><a className='text-white font-raleway underline'>Medellín, Antioquia</a></Link>
          </div>
          <div className="flex space-x-5">
            ...
            <button className="flex items-center text-white font-raleway border border-light-700 px-5 py-3 rounded-lg focus:outline-none">
              <span className="mr-2 text-xl"><MdFilterList /></span>
              Filtros
            </button>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <button className="text-white text-xs font-raleway font-thin tracking-wide bg-light-900 px-2 rounded-md focus:outline-none">ESTUDIO</button>
              </div>
              <div className="flex space-x-5">
                <div className="flex items-center space-x-2 text-white">
                  <span><FaRegCommentDots /></span>
