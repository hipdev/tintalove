    ...
    <div className='py-20 px-10 sm:px-20 lg:px-40 bg-black'>
      <div className='flex flex-wrap justify-around sm:justify-between mb-10'>
        <div className='flex items-center space-x-3 mb-3 sm:mb-0'>
          ...
          <p className='text-gray-500 font-raleway underline'>
            Resultados de: Tribales
          </p>
        </div>
      ...
      <div className='flex justify-between mb-6 border-b-2 border-gray-500'>
        <h1 className='text-white text-xl font-semibold font-raleway'>
          Artistas
        </h1>
        <select
          name=''
          id=''
          className='bg-dark-700 text-white font-raleway px-4 py-2 rounded-lg'
        >
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mb-5'>
        <div>
          ...
          <div className='flex items-center bg-dark-700 rounded-lg p-2 space-x-3'>
            ...
            />
            <div>
              <h1 className='text-white text-lg font-raleway'>
                Daniel Castillo
              </h1>
      ...
      <div className='flex'>
        <button className='text-white border border-white rounded-lg px-5 py-3 mx-auto mt-5 focus:outline-none'>
          Cargar Más
        </button>
      </div>
    </div>
