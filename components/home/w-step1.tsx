    ...
    <div className="h-full flex flex-col">
      ...
      <div className="h-full flex flex-col lg:flex-row justify-evenly items-center">
          ...
          <ol>
            ...
            <li className="relative pb-10">
              ...
              <div  className="relative flex items-start cursor-default">
                ...
                <span className="ml-4 min-w-0 mt-1.5">
                  <span className="text-sm text-light-900 tracking-wide">Información laboral</span>
                </span>
              </div>
            </li>
            <li className="relative pb-10">
        ...
        <div className="relative w-10/12 sm:w-2/3 h-auto bg-dark-700 bg-opacity-50 rounded-xl p-6 sm:p-12 mb-10 lg:mb-0">
          <div>
            <h1 className="text-white text-xl sm:text-2xl font-bold text-center sm:text-left tracking-wide mb-10">Información personal</h1>
            <form action="">
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 md:col-span-3">
                  <label htmlFor="" className="block text-white text-sm uppercase mb-3 tracking-wide">Nombre completo</label>
                  <input type="text" placeholder="Nombre público" className="w-full bg-transparent border-2 border-light-900 p-2 rounded-xl placeholder-light-900 outline-none" />
                </div>
                <div className="col-span-6 md:col-span-3">
                  <label htmlFor="" className="block text-white text-sm uppercase mb-3 tracking-wide">Ubicación</label>
