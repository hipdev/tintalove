...
const PostProfile = ({ post }) => {
  console.log(post.id, 'id del post en profile info')
  const { artist } = useArtist(post.artist_id)

  if (!artist) return <span>Cargando info...</span>
      ...
      <div className="mx-5 sm:mx-20 md:mx-40 lg:mx-48 pt-6">
          ...
          <div className="flex flex-wrap justify-center space-x-5 mb-4 lg:mb-0 mt-8 sm:mt-0 mr-0 md:mr-1 items-center">
            <div className="mb-3 sm:mb-0">
              ...
              <h6 className="text-light-200 text-sm">
                {artist.city_name || 'Sin ciudad'},{' '}
                {artist.province || 'Sin departamento'}
              </h6>
            </div>
        ...
        <div className="mb-5">
          <img
            ...
            src={
              post?.image?.url
                ? `${post.image.url}/tr:pr-true,c-at_max,f-auto,q-100`
            ...
            <div className="w-80 xl:w-96 h-auto bg-ocean_blue-200 px-10 xl:px-13 pt-10 pb-8 ">
                  ...
                  <img
                    src={
                      artist?.profile_picture?.url
                        ? `${artist.profile_picture.url}/tr:pr-true,c-at_max,f-auto,q-100,w-38`
                        : 'https://via.placeholder.com/1100x621'
                    }
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  ...
                  <p className="text-light-500 text-xs mb-5">{artist.times}</p>
                </div>
              </div>
        ...
        <Link href="#">
          <a>
            <img
              ...
              src={
                artist?.profile_picture?.url
                  ? `${artist.profile_picture.url}/tr:pr-true,c-at_max,f-auto,q-100,w-80`
                  : 'https://via.placeholder.com/1100x621'
              }
              alt=""
