    ...
    <div className="bg-dark-800 h-screen px-4 sm:px-16 lg:px-28 overflow-auto pt-10">
      <div className="flex flex-wrap xl:flex-nowrap justify-center xl:justify-start gap-16 xl:gap-24 mt-20">
        <div className="w-11/12 md:w-3/4 xl:w-1/2 h-auto">
          <div className="flex flex-col items-center justify-center w-full h-448 sm:h-609 border-2 border-gray-200 border-dashed rounded-md">
        ...
        <div className="w-11/12 md:w-3/4 xl:w-1/2">
          ...
          <form action="">
            <div className="w-full flex flex-col mb-8">
              ...
              <input
                ...
                className="w-full placeholder-gray-200 bg-gr-800 p-3 rounded-md text-white"
              />
            </div>
            <div className="w-full flex flex-col mb-8">
            ...
            <div className="w-full flex flex-col">
              ...
              <textarea
                ...
                className="w-full placeholder-gray-200 bg-gr-800 p-3 rounded-md resize-none text-white"
              ></textarea>
            </div>
          </form>
          <div className="flex gap-4 sm:gap-8 text-white mt-5 xl:mt-32 ml-5 justify-center mb-5">
            ...
            <button className="flex items-center gap-3 py-3 px-5 sm:px-20 bg-gn-400 hover:bg-gn-500 rounded-md focus:outline-none">
              PUBLICAR
              <span className="text-2xl">
                <BsArrowRight />
              </span>
